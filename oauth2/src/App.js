...
//
const SignInPage: React.FC = (setPubKey, setUserDetails, platform) => {
  ...
  if (showSignUp) return <SignUpForm termsLink="" {...{ onSignInButtonClick, onSignUpComplete }} />
